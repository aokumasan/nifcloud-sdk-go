...
type RdbAPI interface {
	...
	AddSourceIdentifierToSubscriptionWithContext(aws.Context, *rdb.AddSourceIdentifierToSubscriptionInput, ...request.Option) (*rdb.AddSourceIdentifierToSubscriptionOutput, error)
	...
	AuthorizeDBSecurityGroupIngressWithContext(aws.Context, *rdb.AuthorizeDBSecurityGroupIngressInput, ...request.Option) (*rdb.AuthorizeDBSecurityGroupIngressOutput, error)
	...
	CopyDBSnapshotWithContext(aws.Context, *rdb.CopyDBSnapshotInput, ...request.Option) (*rdb.CopyDBSnapshotOutput, error)
	...
	CreateDBInstanceWithContext(aws.Context, *rdb.CreateDBInstanceInput, ...request.Option) (*rdb.CreateDBInstanceOutput, error)
	...
	CreateDBInstanceReadReplicaWithContext(aws.Context, *rdb.CreateDBInstanceReadReplicaInput, ...request.Option) (*rdb.CreateDBInstanceReadReplicaOutput, error)
	...
	CreateDBParameterGroupWithContext(aws.Context, *rdb.CreateDBParameterGroupInput, ...request.Option) (*rdb.CreateDBParameterGroupOutput, error)
	...
	CreateDBSecurityGroupWithContext(aws.Context, *rdb.CreateDBSecurityGroupInput, ...request.Option) (*rdb.CreateDBSecurityGroupOutput, error)
	...
	CreateDBSnapshotWithContext(aws.Context, *rdb.CreateDBSnapshotInput, ...request.Option) (*rdb.CreateDBSnapshotOutput, error)
	...
	CreateEventSubscriptionWithContext(aws.Context, *rdb.CreateEventSubscriptionInput, ...request.Option) (*rdb.CreateEventSubscriptionOutput, error)
	...
	DeleteDBInstanceWithContext(aws.Context, *rdb.DeleteDBInstanceInput, ...request.Option) (*rdb.DeleteDBInstanceOutput, error)
	...
	DeleteDBParameterGroupWithContext(aws.Context, *rdb.DeleteDBParameterGroupInput, ...request.Option) (*rdb.DeleteDBParameterGroupOutput, error)
	...
	DeleteDBSecurityGroupWithContext(aws.Context, *rdb.DeleteDBSecurityGroupInput, ...request.Option) (*rdb.DeleteDBSecurityGroupOutput, error)
	...
	DeleteDBSnapshotWithContext(aws.Context, *rdb.DeleteDBSnapshotInput, ...request.Option) (*rdb.DeleteDBSnapshotOutput, error)
	...
	DeleteEventSubscriptionWithContext(aws.Context, *rdb.DeleteEventSubscriptionInput, ...request.Option) (*rdb.DeleteEventSubscriptionOutput, error)
	...
	DescribeDBEngineVersionsWithContext(aws.Context, *rdb.DescribeDBEngineVersionsInput, ...request.Option) (*rdb.DescribeDBEngineVersionsOutput, error)
	...
	DescribeDBInstancesWithContext(aws.Context, *rdb.DescribeDBInstancesInput, ...request.Option) (*rdb.DescribeDBInstancesOutput, error)
	...
	DescribeDBLogFilesWithContext(aws.Context, *rdb.DescribeDBLogFilesInput, ...request.Option) (*rdb.DescribeDBLogFilesOutput, error)
	...
	DescribeDBParameterGroupsWithContext(aws.Context, *rdb.DescribeDBParameterGroupsInput, ...request.Option) (*rdb.DescribeDBParameterGroupsOutput, error)
	...
	DescribeDBParametersWithContext(aws.Context, *rdb.DescribeDBParametersInput, ...request.Option) (*rdb.DescribeDBParametersOutput, error)
	...
	DescribeDBSecurityGroupsWithContext(aws.Context, *rdb.DescribeDBSecurityGroupsInput, ...request.Option) (*rdb.DescribeDBSecurityGroupsOutput, error)
	...
	DescribeDBSnapshotsWithContext(aws.Context, *rdb.DescribeDBSnapshotsInput, ...request.Option) (*rdb.DescribeDBSnapshotsOutput, error)
	...
	DescribeEngineDefaultParametersWithContext(aws.Context, *rdb.DescribeEngineDefaultParametersInput, ...request.Option) (*rdb.DescribeEngineDefaultParametersOutput, error)
	...
	DescribeEventCategoriesWithContext(aws.Context, *rdb.DescribeEventCategoriesInput, ...request.Option) (*rdb.DescribeEventCategoriesOutput, error)
	...
	DescribeEventSubscriptionsWithContext(aws.Context, *rdb.DescribeEventSubscriptionsInput, ...request.Option) (*rdb.DescribeEventSubscriptionsOutput, error)
	...
	DescribeEventsWithContext(aws.Context, *rdb.DescribeEventsInput, ...request.Option) (*rdb.DescribeEventsOutput, error)
	...
	DescribeOrderableDBInstanceOptionsWithContext(aws.Context, *rdb.DescribeOrderableDBInstanceOptionsInput, ...request.Option) (*rdb.DescribeOrderableDBInstanceOptionsOutput, error)
	...
	DownloadDBLogFilePortionWithContext(aws.Context, *rdb.DownloadDBLogFilePortionInput, ...request.Option) (*rdb.DownloadDBLogFilePortionOutput, error)
	...
	ModifyDBInstanceWithContext(aws.Context, *rdb.ModifyDBInstanceInput, ...request.Option) (*rdb.ModifyDBInstanceOutput, error)
	...
	ModifyDBParameterGroupWithContext(aws.Context, *rdb.ModifyDBParameterGroupInput, ...request.Option) (*rdb.ModifyDBParameterGroupOutput, error)
	...
	ModifyEventSubscriptionWithContext(aws.Context, *rdb.ModifyEventSubscriptionInput, ...request.Option) (*rdb.ModifyEventSubscriptionOutput, error)
	...
	NiftyFailoverDBInstanceWithContext(aws.Context, *rdb.NiftyFailoverDBInstanceInput, ...request.Option) (*rdb.NiftyFailoverDBInstanceOutput, error)
	...
	NiftyGetMetricStatisticsWithContext(aws.Context, *rdb.NiftyGetMetricStatisticsInput, ...request.Option) (*rdb.NiftyGetMetricStatisticsOutput, error)
	...
	RebootDBInstanceWithContext(aws.Context, *rdb.RebootDBInstanceInput, ...request.Option) (*rdb.RebootDBInstanceOutput, error)
	...
	RemoveSourceIdentifierFromSubscriptionWithContext(aws.Context, *rdb.RemoveSourceIdentifierFromSubscriptionInput, ...request.Option) (*rdb.RemoveSourceIdentifierFromSubscriptionOutput, error)
	...
	ResetDBParameterGroupWithContext(aws.Context, *rdb.ResetDBParameterGroupInput, ...request.Option) (*rdb.ResetDBParameterGroupOutput, error)
	...
	RestoreDBInstanceFromDBSnapshotWithContext(aws.Context, *rdb.RestoreDBInstanceFromDBSnapshotInput, ...request.Option) (*rdb.RestoreDBInstanceFromDBSnapshotOutput, error)
	...
	RestoreDBInstanceToPointInTimeWithContext(aws.Context, *rdb.RestoreDBInstanceToPointInTimeInput, ...request.Option) (*rdb.RestoreDBInstanceToPointInTimeOutput, error)
	...
	RevokeDBSecurityGroupIngressWithContext(aws.Context, *rdb.RevokeDBSecurityGroupIngressInput, ...request.Option) (*rdb.RevokeDBSecurityGroupIngressOutput, error)
