...
func main() {
	...
	flag.StringVar(&svcImportPath, "svc-import-path", "github.com/alice02/nifcloud-sdk-go/service", "namespace to generate service client Go code import path under")
	flag.Parse()
	api.Bootstrap()
